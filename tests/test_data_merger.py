...
class TestDataMerger:
    ...
    def test_merge_kline_data_bulk_priority(self, sample_bulk_klines, sample_incremental_klines, merge_config):
    ...
    def test_merge_kline_data_incremental_priority(self, sample_bulk_klines, sample_incremental_klines):
    ...
    def test_merge_funding_rate_data(self, sample_bulk_funding_rates, sample_incremental_funding_rates, merge_config):
    ...
    def test_merge_one_empty_source(self, sample_bulk_klines, merge_config):
        ...
        result = merger.merge_kline_data(
            bulk_data=[],
            incremental_data=sample_bulk_klines,  # Reuse for testing
            symbol="BTCUSDT"
        )
