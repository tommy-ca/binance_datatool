...
class TestWorkflowTasks:
    ...
    async def test_setup_clients(self, mock_settings):
        ...
        with patch('src.crypto_lakehouse.workflows.prefect_workflows.BinanceIngestionClient') as mock_ingestion, \
             patch('src.crypto_lakehouse.workflows.prefect_workflows.S3LakehouseStorage') as mock_storage:
    ...
    async def test_merge_data_sources(self, sample_kline_data):
        ...
        with patch('src.crypto_lakehouse.workflows.prefect_workflows.DataMerger') as mock_merger_class:
            mock_merger = Mock()
    ...
    async def test_validate_data_quality(self, sample_kline_data):
        ...
        result = await validate_data_quality(
            sample_kline_data, "BTCUSDT", DataType.KLINE
        )
...
class TestWorkflowIntegration:
    ...
    async def test_data_ingestion_pipeline_mocked(self, mock_settings, sample_kline_data):
        ...
        with patch('src.crypto_lakehouse.workflows.prefect_workflows.BinanceIngestionClient') as mock_ingestion_class, \
             patch('src.crypto_lakehouse.workflows.prefect_workflows.S3LakehouseStorage') as mock_storage_class, \
             patch('src.crypto_lakehouse.workflows.prefect_workflows.GapDetector') as mock_gap_detector_class, \
             patch('src.crypto_lakehouse.workflows.prefect_workflows.DataMerger') as mock_merger_class, \
             patch('src.crypto_lakehouse.workflows.prefect_workflows.KlineProcessor') as mock_processor_class, \
             patch('src.crypto_lakehouse.workflows.prefect_workflows.DataResampler') as mock_resampler_class:
            ...
            with patch('src.crypto_lakehouse.workflows.prefect_workflows.create_markdown_artifact') as mock_artifact:
    ...
    async def test_multi_symbol_ingestion_pipeline_mocked(self, mock_settings):
        ...
        with patch('src.crypto_lakehouse.workflows.prefect_workflows.data_ingestion_pipeline') as mock_pipeline:
