...
class TestDataIngestion:
    ...
    def test_merge_funding_rates(self, test_data_dir, sample_funding_data):
        ...
        additional_funding = sample_funding_data.tail(10).with_columns(
            pl.col("funding_rate") * 1.1
        )
...
class TestDataProcessing:
    ...
    def test_scan_gaps_basic(self, sample_kline_data_with_gaps):
        ...
        expected_cols = ["prev_begin_time", "candle_begin_time", "prev_close", "open", "time_diff", "price_change"]
...
class TestResampling:
    ...
    def test_resample_different_intervals(self, sample_kline_data):
        ...
        for resample_interval in test_intervals:
            resampled = polars_calc_resample(sample_kline_data, time_interval, resample_interval, "0m")
    ...
    def test_resample_kline_workflow(self, test_data_dir, data_generator):
        ...
        resampled_dir = test_data_dir / "results_data" / trade_type.value / "resampled_klines" / resample_interval
