...
class TestCLI:
    ...
    def test_ingest_funding_rates_spot_error(self):
        ...
        result = self.runner.invoke(
            app, ["ingest", "funding-rates", "--symbols", "BTCUSDT", "--trade-type", "spot"]
        )
    ...
    def test_invalid_date_format(self):
        ...
        result = self.runner.invoke(
            app, ["ingest", "klines", "--symbols", "BTCUSDT", "--start-date", "invalid-date"]
        )
    ...
    def test_enum_validation(self):
        ...
        result = self.runner.invoke(
            app, ["ingest", "klines", "--symbols", "BTCUSDT", "--exchange", "invalid-exchange"]
        )
