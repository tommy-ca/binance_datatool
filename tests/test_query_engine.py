...
def query_config():
    ...
    return QueryConfig(memory_limit="500MB", threads=2, enable_s3=False, enable_parquet=True)
    ...
    data = pl.DataFrame(
        {
            ...
            "close_time": [
                ...
                datetime(2023, 1, 1, 1, 59),
                datetime(2023, 1, 1, 2, 59),
            ],
...
class TestQueryConfig:
    ...
    def test_valid_config(self):
        ...
        config = QueryConfig(memory_limit="1GB", threads=4, enable_s3=True, enable_parquet=True)
