...
def resampling_config() -> ResamplingConfig:
    ...
    return ResamplingConfig(source_timeframe="1m", target_timeframe="5m")
...
class TestResamplingConfig:
    ...
    def test_valid_config(self):
        ...
        config = ResamplingConfig(source_timeframe="1m", target_timeframe="5m")
    ...
    def test_invalid_timeframe(self):
        ...
        with pytest.raises(ValueError, match="Unsupported timeframe"):
            ResamplingConfig(source_timeframe="invalid", target_timeframe="5m")
    ...
    def test_same_timeframes(self):
        ...
        with pytest.raises(ValueError, match="Target timeframe must be different"):
            ResamplingConfig(source_timeframe="1m", target_timeframe="1m")
...
class TestDataResampler:
    ...
    def test_resample_1m_to_1h(self, sample_1m_data):
        ...
        config = ResamplingConfig(source_timeframe="1m", target_timeframe="1h")
    ...
    def test_volume_aggregation(self, sample_1m_data):
        ...
        config = ResamplingConfig(source_timeframe="1m", target_timeframe="5m", include_volume=True)
        resampler = DataResampler(config)
        result = resampler.resample_klines(sample_1m_data, "BTCUSDT")
    ...
    def test_no_volume_config(self, sample_1m_data):
        ...
        config = ResamplingConfig(
            source_timeframe="1m", target_timeframe="5m", include_volume=False, include_trades=False
        )
        resampler = DataResampler(config)
        result = resampler.resample_klines(sample_1m_data, "BTCUSDT")
    ...
    def test_completeness_calculation(self, sample_1m_data):
        ...
        config = ResamplingConfig(
            source_timeframe="1m", target_timeframe="5m", validate_completeness=True
        )
        resampler = DataResampler(config)
        result = resampler.resample_klines(sample_1m_data, "BTCUSDT")
    ...
    def test_completeness_disabled(self, sample_1m_data):
        ...
        config = ResamplingConfig(
            source_timeframe="1m", target_timeframe="5m", validate_completeness=False
        )
        resampler = DataResampler(config)
        result = resampler.resample_klines(sample_1m_data, "BTCUSDT")
...
class TestConvenienceFunctions:
    ...
    def test_resample_data_function(self, sample_1m_data):
        ...
        result = resample_data(
            data=sample_1m_data, symbol="BTCUSDT", source_timeframe="1m", target_timeframe="5m"
        )
...
class TestEdgeCases:
    ...
    def test_single_data_point(self):
        ...
        result = resample_data(
            data=[single_kline], symbol="BTCUSDT", source_timeframe="1m", target_timeframe="5m"
        )
    ...
    def test_irregular_timeframes(self):
        ...
        # Test 15m resampling
        result = resample_data(
            data=data, symbol="BTCUSDT", source_timeframe="1m", target_timeframe="15m"
        )
    ...
    def test_different_symbols(self, sample_1m_data):
        ...
        for symbol in symbols:
            result = resample_data(
                data=sample_1m_data, symbol=symbol, source_timeframe="1m", target_timeframe="5m"
            )
