...
from .core.models import Exchange, DataType, TradeType, Interval, DataIngestionTask
...
def ingest_klines(
    ...
    console.print(f"[bold blue]Ingesting K-line data[/bold blue]")
...
def ingest_funding_rates(
    ...
    console.print(f"[bold blue]Ingesting funding rate data[/bold blue]")
